...
Objetivo: terminar {{MATERIAL PRINCIPAL}} ENTENDIENDO, no solo
consumiendo. Cómo: el sistema de tandas, prácticas y repasos.
Termina cuando: material completo + pendientes en cero + repasos
individuales al día.
...
- Los repasos individuales restantes se terminan acá; después, solo
  integradores.

## FASE 3 — Mundo real / profundización
...
- Recursos y herramientas de F3 (cambian; se busca lo vigente).
- El tema exacto del integrador de F2 (se elige juntos; mejor si me
  gusta: se aprende más).
